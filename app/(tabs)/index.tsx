...
export default function HomeScreen() {
  const { streak, completedWorkouts } = useWorkoutStore();
      ...
      <View className="p-6 pt-12">
        ...
        <View className="flex-row gap-4 mb-8">
          <View className="flex-1 bg-[#121a24] rounded-2xl p-5 border border-[#c5a46e]/20">
            ...
            <Text className="text-white text-4xl font-bold mt-1">{streak}</Text>
            <Text className="text-[#a0aec0]">days</Text>
          </View>
          <View className="flex-1 bg-[#121a24] rounded-2xl p-5 border border-[#c5a46e]/20">
            <Text className="text-[#c5a46e] text-sm tracking-widest">WORKOUTS DONE</Text>
            <Text className="text-white text-4xl font-bold mt-1">{completedWorkouts.length}</Text>
